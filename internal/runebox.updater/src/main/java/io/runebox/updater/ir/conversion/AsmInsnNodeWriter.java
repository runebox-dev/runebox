...
import io.runebox.updater.ir.analysis.JvmType;
import io.runebox.updater.ir.analysis.Stack;
import io.runebox.updater.ir.constant.*;
import io.runebox.updater.ir.conversion.stack2asm.AsmUtil;
import io.runebox.updater.ir.conversion.stack2asm.ConversionContext;
import io.runebox.updater.ir.handle.*;
import io.runebox.updater.ir.stack.StackLocal;
import io.runebox.updater.ir.stack.insn.DupInsn;
...
public class AsmInsnNodeWriter extends StackInsnVisitor<Instruction, StackLocal> {
     ...
     */
    private io.runebox.updater.ir.analysis.Stack.Immutable<JvmType> stackFrame;
