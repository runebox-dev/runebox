...
import io.runebox.updater.ir.analysis.Analysis;
import io.runebox.updater.ir.analysis.Stack;
...
import io.runebox.updater.ir.stack.insn.BranchInsn;
...
import io.runebox.updater.ir.util.StackInsnReader;
...
public class BodyConverter {
    ...
    private final io.runebox.updater.ir.analysis.Stack.Mutable<StackValue> stack = new io.runebox.updater.ir.analysis.Stack.Mutable<>();
    ...
    private void convertInsns() {
        ...
        worklist.add(new CfgNode(firstInstruction, new io.runebox.updater.ir.analysis.Stack.Immutable<>()));
        ...
        this.stackBody.getTryCatchBlocks().forEach(stackTryCatchBlock -> {
            ...
            io.runebox.updater.ir.analysis.Stack.Mutable<StackValue> stack = new io.runebox.updater.ir.analysis.Stack.Mutable<>();
     ...
     */
    private void convertTryCatchBlock(io.runebox.updater.ir.stack.TryCatchBlock stackTryCatchBlock, RefLocal caughtExceptionLocal) {
        Optional<Path> exception = stackTryCatchBlock.getExceptionType();
        io.runebox.updater.ir.ref.TryCatchBlock refTryCatchBlock = new io.runebox.updater.ir.ref.TryCatchBlock(null, null, null, exception, caughtExceptionLocal);
    ...
    private class CfgNode {
         ...
         * Values on the stack
         */
        private final io.runebox.updater.ir.analysis.Stack.Immutable<StackValue> stack;
