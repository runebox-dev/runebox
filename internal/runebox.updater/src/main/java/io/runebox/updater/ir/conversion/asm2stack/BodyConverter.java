...
import io.runebox.updater.ir.conversion.AsmInsnReader;
import io.runebox.updater.ir.conversion.AsmStackInsnWriter;
...
public class BodyConverter {
    ...
    private void runAsmClassAnalysis() {
        String owner = classfile.getNamePath().join('/');
        try {
