...
import io.runebox.updater.ir.typeannotation.ClassTypeAnnotation;
...
public class Classfile {
     ...
     *
     * May be {@code null} when reading the bytecode of class {@link Object}.
     */
     ...
     * set to the {@link Classfile#namePath} of this class.
     */
    ...
    public Classfile(Version version, Path namePath, Path supertype, List<Path> interfaces) {
    ...
    public String getName() { return namePath.getName(); }
    public void setName(String name) { this.namePath = new Path(this.namePath.getPackage(), name); }

    public void setNamePath(Path namePath) {
        this.namePath = namePath;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(version, classfile.version) &&
                ...
                Objects.equals(namePath, classfile.namePath) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(version, flags, namePath, supertype, interfaces, signature, source,
