...
import io.runebox.updater.ir.typeannotation.MethodTypeAnnotation;
...
public class MethodConvertVisitor extends JSRInlinerAdapter {
    ...
    public void visitAttribute(Attribute attribute) {
        method.getAttributes().add(new io.runebox.updater.ir.Attribute(attribute.type, AsmUtil.getAttributeData(attribute)));
    }
