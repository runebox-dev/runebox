...
import io.runebox.updater.ir.textify.core.ConstantTextifier;
import io.runebox.updater.ir.textify.core.Printer;
import io.runebox.updater.ir.textify.core.Textifier;
import io.runebox.updater.ir.textify.core.TypeTextifier;
...
public class ExpressionTextifier implements CtxTextifier<Expression> {
    ...
    private static final ExpressionTextifier INSTANCE = new ExpressionTextifier();    public static final CtxTextifier<AbstractBinaryExpr> MATH_EXPR = (printer, ctx, expr) -> {
