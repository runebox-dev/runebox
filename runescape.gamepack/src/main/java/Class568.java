...
public final class Class568 extends Class569 {
	...
	public void method10111() {
		if (this.field5499 != this.field5495 || this.field5498 != this.field5496) {
			...
			for (int var3 = 0; var3 < this.field5496; ++var3) {
				for (int var4 = 0; var4 < this.field5495; ++var4) {
					var1[(this.field5493 + var3) * this.field5499 + this.field5494 + var4] = this.field5497[var2++];
				}
			}
	...
	public void method10120(int var1, int var2, int var3, int var4) {
		...
		if (this.field5494 > 0) {
			...
			var1 += var13;
			var7 += var11 * var13 - (this.field5494 << 16);
		}

		if (this.field5493 > 0) {
			var13 = ((this.field5493 << 16) + var12 - 1) / var12;
			var2 += var13;
			var8 += var12 * var13 - (this.field5493 << 16);
		}
