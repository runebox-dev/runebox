...
public class Class506 extends Class507 {
	...
	public Class506(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		...
		if ((var8 - var2) * (var4 - var7) == (var7 - var1) * (var5 - var8)) {
			...
			this.field5087 = (var17 + (var19 * var11 - var21 * var15) - var13) / (var19 - var21);
	...
	public int method8957() {
		...
		double var4 = var2 * (this.field5086 - this.field5090) + this.field5090;
	...
	public int method8958() {
		double var2 = this.method9003();
		double var4 = this.field5090 + var2 * (this.field5086 - this.field5090);
	...
	public int method8956() {
		double var2 = this.method9003();
		return (int)Math.round((double)this.field5085 + (double)(this.field5091 - this.field5085) * var2);
	}
}
