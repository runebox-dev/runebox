...
public abstract class Class511 {
	...
	public static double method8475(int var0, int var1, int var2) {
		...
		if (var4 > 0.0D && var4 < 1.0D) {
			...
			case 3:
				return -(Math.cos(3.141592653589793D * var4) - 1.0D) / 2.0D;
			case 4:
				return var4 * var4;
			case 5:
				return 1.0D - (1.0D - var4) * (1.0D - var4);
			case 6:
				return var4 < 0.5D ? var4 * 2.0D * var4 : 1.0D - Math.pow(2.0D + -2.0D * var4, 2.0D) / 2.0D;
			case 7:
			...
			case 12:
				return var4 < 0.5D ? var4 * var4 * var4 * 8.0D * var4 : 1.0D - Math.pow(2.0D + var4 * -2.0D, 4.0D) / 2.0D;
			case 13:
				return var4 * var4 * var4 * var4 * var4;
			case 14:
				return 1.0D - Math.pow(1.0D - var4, 5.0D);
			case 15:
				return var4 < 0.5D ? var4 * var4 * var4 * var4 * 8.0D * var4 : 1.0D - Math.pow(-2.0D * var4 + 2.0D, 5.0D) / 2.0D;
			case 16:
			...
			case 21:
				return var4 < 0.5D ? (1.0D - Math.sqrt(1.0D - Math.pow(2.0D * var4, 2.0D))) / 2.0D : (Math.sqrt(1.0D - Math.pow(2.0D + -2.0D * var4, 2.0D)) + 1.0D) / 2.0D;
			case 22:
				var6 = 1.70158D;
				var8 = 2.70158D;
			...
			case 24:
				var6 = 1.70158D;
				var8 = 2.5949095D;
				return var4 < 0.5D ? Math.pow(2.0D * var4, 2.0D) * (7.189819D * var4 - 2.5949095D) / 2.0D : (Math.pow(2.0D * var4 - 2.0D, 2.0D) * (3.5949095D * (var4 * 2.0D - 2.0D) + 2.5949095D) + 2.0D) / 2.0D;
			case 25:
			...
			case 27:
				...
				return var4 < 0.5D ? -(Math.pow(2.0D, var4 * 20.0D - 10.0D) * var8) / 2.0D : Math.pow(2.0D, 10.0D + -20.0D * var4) * var8 / 2.0D + 1.0D;
			default:
				return var4;
			}
		} else {
