		...
		if (var0 != null && var0.method3162() != 0) {
			...
			if ((double)var7 == 0.0D) {
				...
				if (var2) {
					...
					} else if (Class141.field1616 != var0.field1645 && Class141.field1611 != var0.field1645) {
						if (Class141.field1609 == var0.field1645) {
							var12 = var5 - var1;
				...
				} else if (Class141.field1612 == var0.field1626) {
					if ((double)var11 != 0.0D) {
						var12 = var6 - var12;
					} else {
						var12 += var5;
					}
				} else if (Class141.field1616 != var0.field1626 && Class141.field1611 != var0.field1626) {
					if (Class141.field1609 == var0.field1626) {
						var12 = var1 - var6;
				...
				float var19;
				if (var2 && Class141.field1611 == var0.field1645) {
