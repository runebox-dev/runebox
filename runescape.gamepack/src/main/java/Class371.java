public class Class371 implements Class393 {
	...
	static {
		field4029 = new Class371(0, -1, true, false, true);
		field4013 = new Class371(1, 0, true, true, true);
		field4032 = new Class371(2, 1, true, true, false);
		field4015 = new Class371(3, 2, false, false, true);
		field4016 = new Class371(4, 3, false, false, true);
		field4017 = new Class371(5, 10, false, false, true);
		field4025 = new Class371(6, 22, false, false, true);
		field4019 = new Class371(7, 41, false, false, true);
		field4028 = new Class371(8, 42, false, false, true);
		field4018 = new Class371(9, 43, false, false, true);
		field4022 = new Class371(10, 44, false, false, true);
		field4023 = new Class371(11, 45, false, false, true);
		field4014 = new Class371(12, 46, false, false, true);
		field4012 = new Class371(13, 47, false, false, true);
		field4024 = new Class371(14, 48, false, false, true);
		field4027 = new Class371(15, 49, false, false, true);
		field4030 = new Class371(16, 52, false, false, true);
	}

	public Class371(int var1, int var2, boolean var3, boolean var4, boolean var5) {
		this.field4020 = var1;
		this.field4026 = var2;
		this.field4031 = var4;
		this.field4021 = var5;
