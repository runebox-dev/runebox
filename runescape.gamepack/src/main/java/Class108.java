			...
			if (var3.field1025 != null && var3.field1029 != null) {
				...
				if (!var32 && 0 == Client.field608 && !var3.field1015) {
					...
					if (-1 != var23.field4026) {
						Class128.method2747(var14, Class113.method6223(var23.field4026) + var3.field1025.method10260(), var33);
					} else {
			...
			if (var3.field1025 != null && var3.field1029 != null) {
				...
				if (!var34 && 0 == Client.field608 && !var3.field1015) {
					...
					if (-1 != var28.field4026) {
						Class128.method2747(var35, Class113.method6223(var28.field4026) + var3.field1025.method10260(), var15);
					} else {
